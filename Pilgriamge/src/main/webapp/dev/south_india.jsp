            ...
            <div class="text-center mb-3 pb-3">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        ...
                        <div class="p-4">
                            ...
                            <a class="h5 text-decoration-none" href="">Meenakshi Amman Temple</a>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        ...
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Trivandrum</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i>3 days</small>
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i>2 Person</small>
                            </div>
                            <a class="h5 text-decoration-none" href="">Padmanabhaswamy Temple</a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.5 <small>(250)</small></h6>
                                    <h5 class="m-0">$350</h5>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        ...
                        <div class="p-4">
                            ...
                            <a class="h5 text-decoration-none" href="">Ramanathaswamy Temple</a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.5 <small>(250)</small></h6>
                                    <h5 class="m-0">$350</h5>
                ...
                <div class="col-lg-8 col-md-8 mb-8">
                    <div class="package-item bg-white mb-2">
                     <div style="width:100%;height:390px;overflow:scroll;padding:5px;">
                      	<p>The Ramanathaswamy Temple is the most notable historic landmark of Rameshwaram. This temple is a famous Hindu temple dedicated to the Lord Shiva. The temple is one of the 12 Jyotirlinga shrines, where Shiva is worshipped in the form of a Jyotirlinga meaning "pillar of light". It is also one of the 275 Paadal Petra Sthalam temples and is glorified in hymns by the three of the most revered Nayanar saints (7th century Saivite saints), Appar, Sundarar and Tirugnana Sambandar. The temple in its current structure was built during the 12th century by Pandya Dynasty. The temple has the longest corridor among all Hindu temples in India.<br><br>
                      	Legend has it that Rama worshipped Lord Shiva in the form of a Shiva Lingam made of earth by Sita, while returning to Ayodhya. Legend has it that Lord Hanuman was entrusted with the task of bringing an image of Viswanath from Banaras. Anticipating delay in Hanuman's return from Banaras, Lord Rama is said to have offered worship at a pre-chosen auspicious moment to a Shivalingam fashioned out of earth by Sita. This lingam is referred to as Ramalingam and the town is known as Rameswaram.<br><br>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/kumariammana.jpg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Kanyakumari</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i>3 days</small>
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i>2 Person</small>
                            </div>
                            <a class="h5 text-decoration-none" href="">Kumariamman Temple</a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.5 <small>(250)</small></h6>
                                    <h5 class="m-0">$350</h5>
